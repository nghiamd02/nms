...
// diary when the app starts
  ...
  void _showForm(int? id) async {
    if (id != null) {
      final existingJournal =
          _journals.firstWhere((element) => element[columnCategoryId] == id);
      _nameController.text = existingJournal[columnCategoryTitle];
    }
  ...
  Future<void> _addCategory() async {
    await CategoryHelper.createCategory(
      Category(title: _nameController.text, createAt: getCurrentDateTime()),
    );
    _refreshJournals();
  }
      ...
      body: _isLoading
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) => Card(
                ...
                child: ListTile(
                    title: Text("Name: ${_journals[index][columnCategoryTitle]}"),
                      ...
                      child: Row(
                        children: [
                          IconButton(
                            ...
                            onPressed: () => _showForm(_journals[index][columnCategoryId]),
                          ), // IconButton
                          IconButton(
                            icon: const Icon(Icons.delete),
                            onPressed: () =>
                                _deleteCategory(_journals[index][columnCategoryId]),
                          ),
                        ],
                      ),
                    )),
